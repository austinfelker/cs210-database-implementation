...
import types.Response; // TODO read-only
import types.SearchList; // TODO read-only
import types.Table; // TODO read-only
	...
	protected static Arguments[] data() {
		...
		for (var a = 0; a < arguments.length; a++) {
			...
			if (serial_data[a] != null) {
				...
				table = new Table(
					SearchList.<String, Object>of(
						"table_name", table_name,
						"column_names", column_names,
						"column_types", column_types,
						"primary_index", primary_index
					),
					new SearchList<Object, List<Object>>()
				);
