...
public class Module1 extends SQLModule {
	...
	public static void setup() {
		...
		query_data = new Object[][]{
			...
			{ false, "m1_table23", "CREATE TABLE m1_table23 (id INTEGER, name STRING, flag BOOLEAN)", "there must be a primary column" },
			{ false, "m1_table24", "CREATE TABLE m1_table24 (id INTEGER PRIMARY, name STRING PRIMARY, flag BOOLEAN PRIMARY)", "there can be only one primary column" },
			{ true,  "m1_table25", "CREATE TABLE m1_table25 (id INTEGER, name STRING PRIMARY, flag BOOLEAN)", "the primary column need not be the first" },
			{ false, "m1_table01", "CREATE TABLE m1_table01 (ps STRING PRIMARY)", "the table name must not already be in use" },
			...
			{ true,  "_tables", " SHOW TABLES ", "untrimmed whitespace is allowed" },
			{ true,  "_tables", "SHOW  TABLES", "excess internal whitespace is allowed" },
			...
			{ false, null, "AN INVALID QUERY", "an unrecognized query should be rejected" },
		...
		serial_data = new Object[][]{
			...
			null,
			null,
			{ "m1_table25", 3, 1, "id", "name", "flag", "integer", "string", "boolean" },
			{ "m1_table01", 3, 0, "id", "name", "flag", "integer", "string", "boolean" },
			null,
			null,
			null,
			...
			{ "_tables", 2, 0, "table_name", "row_count", "string", "integer", "m1_table25", 0, "m1_table05", 0, "m1_table06", 0, "m1_table01", 0, "m1_table10_____", 0, "m1_table20", 0, "m1_table21", 0, "m1_table19", 0 },
			{ "_tables", 2, 0, "table_name", "row_count", "string", "integer", "m1_table25", 0, "m1_table05", 0, "m1_table06", 0, "m1_table01", 0, "m1_table10_____", 0, "m1_table20", 0, "m1_table21", 0, "m1_table19", 0 },
			{ "_tables", 2, 0, "table_name", "row_count", "string", "integer", "m1_table25", 0, "m1_table05", 0, "m1_table06", 0, "m1_table01", 0, "m1_table10_____", 0, "m1_table20", 0, "m1_table21", 0, "m1_table19", 0 },
			{ "_tables", 2, 0, "table_name", "row_count", "string", "integer", "m1_table25", 0, "m1_table05", 0, "m1_table06", 0, "m1_table01", 0, "m1_table10_____", 0, "m1_table20", 0, "m1_table21", 0, "m1_table19", 0 },
			null,
